...
<%--                                            <li id="footer" class="menulink footer">Powered by <a href="http://webjea.com" target="_blank">Automation Dashboard</a> <asp:Literal runat="server" ID="lblVersion"></asp:Literal>.</li>--%>
                                        </ul>
                                    </LayoutTemplate>
                                    <ItemTemplate>
                                ...
                                <div id="footer" class="footer">Powered by <a href="http://webjea.com" target="_blank">Automation Dashboard</a><asp:Literal runat="server" ID="lblVersion"></asp:Literal>.</div>
                            </div>
                        </div>
                    </div>
                </div>
