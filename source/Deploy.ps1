...
$MyData = @{
    AllNodes = @(
        @{
            ...
            AppPoolUserName = 'lpu\amanasr'
            AppPoolPassword = "Voidmain@7907" #no credential data is actually password because we're using gMSAs
        ...
        @{
            NodeName = 'lpuwebjea'
            Role = 'WebJEAServer'
            MachineFQDN = 'lpuwebjea.lpu.com'
            CertThumbprint = '4fc486e6931f04e15ad17387e7371508e3d54c2f'
        }
    )
}
